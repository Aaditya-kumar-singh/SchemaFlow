    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8 transition-colors duration-300">
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <img className="mx-auto h-12 w-auto rounded-lg" src="/logo.png" alt="SchemaFlow" />
            ...
            <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div className="bg-white dark:bg-slate-900 py-8 px-4 shadow sm:rounded-lg sm:px-10 border dark:border-slate-800 transition-colors duration-300">
                    ...
                    <form className="space-y-6" onSubmit={handleLogin}>
                        <div>
                            ...
                            <div className="mt-1">
                                <Input
                                    ...
                                    className="text-gray-900 dark:text-slate-100 dark:bg-slate-800 dark:border-slate-700 dark:placeholder:text-slate-500"
                                />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="mt-1 relative">
                                <Input
                                    ...
                                    required
                                    placeholder="••••••••"
                                    className="pr-10 text-gray-900 dark:text-slate-100 dark:bg-slate-800 dark:border-slate-700 dark:placeholder:text-slate-500"
                                />
                                <button
                                    type="button"
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                <input
                                    ...
                                    name="remember-me"
                                    type="checkbox"
                                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded dark:bg-slate-800 dark:border-slate-600"
                                />
                        ...
                        <div>
                            <Button type="submit" disabled={isLoading || loadingState} className="w-full flex justify-center bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-500 text-white">
                                {isLoading || loadingState ? 'Signing in...' : 'Sign in'}
                            </Button>
                        </div>
                    </form>
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-3">
                            <div>
                                <Button variant="outline" className="w-full justify-center dark:bg-slate-800 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-700">
