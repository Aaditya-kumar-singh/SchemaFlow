                    ...
                    <form className="space-y-6" onSubmit={handleRegister}>
                        ...
                        <div>
                            <Button type="submit" disabled={isLoading || loadingState} className="w-full flex justify-center bg-blue-600 hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-500 text-white">
                                {isLoading || loadingState ? 'Creating account...' : 'Create Account'}
                            </Button>
                        </div>
                    </form>
                    ...
                    <div className="mt-6">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-2 bg-white dark:bg-slate-900 text-gray-500 dark:text-slate-500">Or sign up with</span>
                            </div>
                        </div>
